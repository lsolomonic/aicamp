...
BIRD_IMGS = [pygame.image.load('sprites/bird2.png'),
             pygame.image.load('sprites/bird1.png'),
             pygame.image.load('sprites/bird3.png')]
BOTTOM_PIPE_IMG = pygame.image.load('sprites/pipe.png')
TOP_PIPE_IMG = pygame.transform.flip(BOTTOM_PIPE_IMG, False, True) 
FLOOR_IMG = pygame.image.load('sprites/base.png')
BG_IMG = pygame.transform.scale(pygame.image.load('sprites/bg.png'), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
def draw_game(screen, birds, pipes, floor, score, generation, game_time):
    ...
    progress_text = FONT.render('Pipes Remaining: ' + str(len(pipes) - score), 1, FONT_COLOR) 
